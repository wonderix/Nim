...
type
  DoublyLinkedNodeObj*[T] = object ## \
    ...
    next*: owned(ref DoublyLinkedNodeObj[T])
  ...
  SinglyLinkedNodeObj*[T] = object ## \
    ...
    next*: owned(ref SinglyLinkedNodeObj[T])
    value*: T
...
proc newDoublyLinkedNode*[T](value: T): owned(DoublyLinkedNode[T]) =
...
proc newSinglyLinkedNode*[T](value: T): owned(SinglyLinkedNode[T]) =
